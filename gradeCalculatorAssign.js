...
console.log("Marks of maths is ".concat(marks1));
console.log("Marks of Physics is ".concat(marks2));
console.log("Marks of Chemistry is ".concat(marks3));
var avg = (marks1 + marks2 + marks3) / 3;
console.log("Average score is: ".concat(avg));
if (avg > 90) {
